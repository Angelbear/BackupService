...
public class CloudStorage {
	...
	private boolean putFile(String file, String uid, String token,
		...
		try {
			HttpResponse r = AndroidHttpClient.newInstance("Android")
					.execute(p);
	...
	private boolean deleteFile(String file, String uid, String token,
			InputStream is, long length) {
	...
	private InputStream downloadFile(String file, String uid, String token) {
		String url = String.format(MYPREFERENCES_URL_TEP, uid, file);
		String authInfo = String.format("CPK %s:%s", uid, token);
